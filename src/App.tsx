      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <div className="flex items-center justify-center gap-2 mt-4">
            <button
              ...
              className="inline-flex items-center gap-2 px-3.5 py-2 text-xs font-medium text-ink-muted hover:text-ink ui-btn-surface ui-interactive focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                <button
                  ...
                  className="px-3 py-2 text-xs font-medium bg-surface-2 border border-hairline text-ink rounded-md ui-interactive focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
                >
                  🐢 {t('presetSlow')}
                  <br />
                ...
                <button
                  ...
                  className="px-3 py-2 text-xs font-medium ui-btn-primary ui-interactive focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
                >
                  ▶️ {t('presetNormal')}
                  <br />
        ...
        <div className="text-center mb-4">
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 text-ink text-sm font-medium ui-btn-surface ui-interactive"
          >
