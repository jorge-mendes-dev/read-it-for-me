      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <div className="flex items-center justify-center gap-2 mt-4">
            <button
              ...
              className="inline-flex items-center gap-2 px-3.5 py-2 text-xs font-medium text-ink-muted hover:text-ink bg-surface-1 hover:bg-surface-2 rounded-md transition-all duration-200 hover:-translate-y-px active:translate-y-0 active:scale-[0.98] border border-hairline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
        ...
        <div className="bg-surface-1 rounded-lg border border-hairline mb-4 overflow-hidden">
          ...
          >
            ...
            <button
              ...
              className="w-full py-2 px-3 bg-primary text-white text-sm font-medium rounded-md transition-all duration-200 hover:bg-primary-hover hover:-translate-y-px active:translate-y-0 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 flex items-center justify-center gap-2"
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                <button
                  ...
                  className="px-3 py-2 text-xs font-medium bg-surface-2 border border-hairline text-ink rounded-md transition-all duration-200 hover:bg-surface-3 hover:-translate-y-px active:translate-y-0 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
                >
                  🐢 {t('presetSlow')}
                  <br />
                ...
                <button
                  ...
                  className="px-3 py-2 text-xs font-medium bg-primary text-white rounded-md transition-all duration-200 hover:bg-primary-hover hover:-translate-y-px active:translate-y-0 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
                >
                  ▶️ {t('presetNormal')}
                  <br />
              ...
              <label className="flex items-center justify-between cursor-pointer group">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => {
                      const value = e.target.checked
                      setWordHighlightEnabled(value)
                      browser.storage.local.set({ wordHighlightEnabled: value })
                    }}
                    className="sr-only peer"
                  />
                  <div className="w-11 h-6 bg-surface-3 border border-hairline peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-primary/50 rounded-pill peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-hairline after:border after:rounded-pill after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => {
                      const value = e.target.checked
                      setSmartRead(value)
                      browser.storage.local.set({ smartRead: value })
                    }}
                    className="sr-only peer"
                  />
                  <div className="w-11 h-6 bg-surface-3 border border-hairline peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-primary/50 rounded-pill peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-hairline after:border after:rounded-pill after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
        ...
        <div className="text-center mb-4">
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-surface-1 hover:bg-surface-2 border border-hairline text-ink text-sm font-medium rounded-md transition-all duration-200 hover:-translate-y-px active:translate-y-0 active:scale-[0.98]"
          >
        ...
        <div className="text-center text-xs text-ink-subtle">
          <p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-primary hover:text-primary-hover font-medium hover:underline transition-all duration-200 hover:-translate-y-px"
            >
              Jorge Mendes
            </a>
          </p>
