let r=null,C={},B=!1,T={x:0,y:0},z=!1;async function K(){return new Promise((t,e)=>{browser.storage.local.get(["selectedLocale"],async i=>{const n=i.selectedLocale||"en";try{const l=browser.runtime.getURL(`_locales/${n}/messages.json`),o=await fetch(l);if(!o.ok)throw new Error(`HTTP ${o.status}`);C=await o.json(),t()}catch(l){console.error("[FloatingPlayer] Failed to load locale:",n,l);try{const o=browser.runtime.getURL("_locales/en/messages.json");C=await(await fetch(o)).json(),t()}catch(o){console.error("[FloatingPlayer] Failed to load fallback locale:",o),e(o)}}})})}function d(t){return C[t]?C[t].message:(console.warn(`[FloatingPlayer] Translation missing for key: ${t}`),t)}function N(){var x,v,h,k,L,M,U;if(r)return;if(Object.keys(C).length===0){console.error("[FloatingPlayer] Cannot create player - no messages loaded!");return}r=document.createElement("div"),r.id="read-it-for-me-player",r.innerHTML=`
    <style>
  ...
  `,document.body.appendChild(r),browser.storage.local.get(["defaultRate","defaultPitch","defaultVolume","showProgressBar"],s=>{const a=r==null?void 0:r.querySelector("#rifm-speed-slider"),g=r==null?void 0:r.querySelector("#rifm-pitch-slider"),w=r==null?void 0:r.querySelector("#rifm-volume-slider"),R=r==null?void 0:r.querySelector(".rifm-progress-bar");R&&(R.style.display=s.showProgressBar!==!1?"block":"none"),a&&s.defaultRate!==void 0&&(a.value=s.defaultRate.toString(),y("speed",s.defaultRate),r==null||r.querySelectorAll(".rifm-preset-btn").forEach($=>{const J=parseFloat($.dataset.speed||"1.0");Math.abs(J-s.defaultRate)<.01?$.classList.add("active"):$.classList.remove("active")})),g&&s.defaultPitch!==void 0&&(g.value=s.defaultPitch.toString(),y("pitch",s.defaultPitch)),w&&s.defaultVolume!==void 0&&(w.value=s.defaultVolume.toString(),y("volume",s.defaultVolume))}),(x=r.querySelector("#rifm-close"))==null||x.addEventListener("click",E),(v=r.querySelector("#rifm-stop"))==null||v.addEventListener("click",()=>{browser.runtime.sendMessage({action:"stopReading"}),E()}),(h=r.querySelector("#rifm-play-pause"))==null||h.addEventListener("click",P),(k=r.querySelector("#rifm-mini-toggle"))==null||k.addEventListener("click",()=>{z=!z,r==null||r.classList.toggle("mini-mode",z);const s=r==null?void 0:r.querySelector("#rifm-mini-toggle svg");s&&(s.innerHTML=z?'<path d="M4 8h16M4 16h16"/>':'<path d="M19 13H5v-2h14v2z"/>')}),(L=r.querySelector("#rifm-clear-queue"))==null||L.addEventListener("click",()=>{browser.runtime.sendMessage({action:"clearQueue"})}),r.querySelectorAll(".rifm-preset-btn").forEach(s=>{s.addEventListener("click",()=>{const a=parseFloat(s.dataset.speed||"1.0"),g=r==null?void 0:r.querySelector("#rifm-speed-slider");g&&(g.value=a.toString(),y("speed",a),browser.runtime.sendMessage({action:"updateSettings",rate:a}),browser.storage.local.set({defaultRate:a})),r==null||r.querySelectorAll(".rifm-preset-btn").forEach(w=>w.classList.remove("active")),s.classList.add("active")})}),(M=r.querySelector("#rifm-reset-btn"))==null||M.addEventListener("click",()=>{var R;const s={rate:.9,pitch:1,volume:1},a=r==null?void 0:r.querySelector("#rifm-speed-slider"),g=r==null?void 0:r.querySelector("#rifm-pitch-slider"),w=r==null?void 0:r.querySelector("#rifm-volume-slider");a&&(a.value=s.rate.toString(),y("speed",s.rate)),g&&(g.value=s.pitch.toString(),y("pitch",s.pitch)),w&&(w.value=s.volume.toString(),y("volume",s.volume)),r==null||r.querySelectorAll(".rifm-preset-btn").forEach($=>$.classList.remove("active")),(R=r==null?void 0:r.querySelector('.rifm-preset-btn[data-speed="1.0"]'))==null||R.classList.add("active"),browser.storage.local.set({defaultRate:s.rate,defaultPitch:s.pitch,defaultVolume:s.volume}),browser.runtime.sendMessage({action:"updateSettings",rate:s.rate,pitch:s.pitch,volume:s.volume})}),(U=r.querySelector("#rifm-settings-toggle"))==null||U.addEventListener("click",()=>{const s=r==null?void 0:r.querySelector("#rifm-config-panel"),a=r==null?void 0:r.querySelector("#rifm-settings-toggle");s==null||s.classList.toggle("open"),a==null||a.classList.toggle("active")});let t=r.querySelector(".rifm-header");t==null||t.addEventListener("mousedown",e);function e(s){if(s.target.closest("button"))return;B=!0;const a=r.getBoundingClientRect();T.x=s.clientX-a.left,T.y=s.clientY-a.top,document.addEventListener("mousemove",i),document.addEventListener("mouseup",n),s.preventDefault()}function i(s){if(!B||!r)return;let a=s.clientX-T.x,g=s.clientY-T.y;const w=r.getBoundingClientRect();a=Math.max(0,Math.min(a,window.innerWidth-w.width)),g=Math.max(0,Math.min(g,window.innerHeight-w.height)),r.style.left=a+"px",r.style.top=g+"px",r.style.bottom="auto",r.style.right="auto"}function n(){B=!1,document.removeEventListener("mousemove",i),document.removeEventListener("mouseup",n)}const l=r.querySelector("#rifm-speed-slider"),o=r.querySelector("#rifm-pitch-slider"),c=r.querySelector("#rifm-volume-slider");l==null||l.addEventListener("input",s=>{const a=parseFloat(s.target.value);y("speed",a),browser.runtime.sendMessage({action:"updateSettings",rate:a}),browser.storage.local.set({defaultRate:a})}),o==null||o.addEventListener("input",s=>{const a=parseFloat(s.target.value);y("pitch",a),browser.runtime.sendMessage({action:"updateSettings",pitch:a}),browser.storage.local.set({defaultPitch:a})}),c==null||c.addEventListener("input",s=>{const a=parseFloat(s.target.value);y("volume",a),browser.runtime.sendMessage({action:"updateSettings",volume:a}),browser.storage.local.set({defaultVolume:a})})}function y(t,e){const i=r==null?void 0:r.querySelector(`#rifm-${t}-value`);i&&(t==="volume"?i.textContent=`${Math.round(e*100)}%`:i.textContent=`${e.toFixed(1)}x`)}async function H(){r||(await K(),N()),r&&r.classList.add("show")}function E(){r==null||r.classList.remove("show")}function j(t){if(!r)return;const e=r.querySelector("#rifm-icon"),i=r.querySelector("#rifm-btn-text"),n=r.querySelector("#rifm-status-text");t?(e&&(e.innerHTML='<path d="M8 5v14l11-7z"/>'),i&&(i.textContent=d("resume")),n&&(n.textContent=d("paused"))):(e&&(e.innerHTML='<path d="M6 4h4v16H6V4zm8 0h4v16h-4V4z"/>'),i&&(i.textContent=d("pause")),n&&(n.textContent=d("reading")))}function V(t){const e=r==null?void 0:r.querySelector("#rifm-queue-badge"),i=r==null?void 0:r.querySelector("#rifm-clear-queue");e&&(t>0?(e.textContent=t.toString(),e.setAttribute("style","display: inline-block;")):e.setAttribute("style","display: none;")),i&&i.setAttribute("style",t>0?"display: block;":"display: none;")}function D(t,e){const i=r==null?void 0:r.querySelector("#rifm-progress-fill");if(i&&e>0){const n=t/e*100;i.style.width=`${n}%`}}function Z(t){const e=r==null?void 0:r.querySelector("#rifm-time-estimate");if(e)if(t>60){const i=Math.ceil(t/60);e.textContent=`~${i}min`}else e.textContent=`~${Math.ceil(t)}s`}function P(){browser.runtime.sendMessage({action:"getState"},t=>{t.isPaused?browser.runtime.sendMessage({action:"resumeReading"}):browser.runtime.sendMessage({action:"pauseReading"})})}browser.runtime.onMessage.addListener(t=>{if(t.action==="stateUpdate"){const{isReading:e,isPaused:i}=t.state;e?H().then(()=>j(i)).catch(console.error):E()}});window.addEventListener("rifm-state-update",t=>{const{isReading:e,isPaused:i}=t.detail;e?H().then(()=>j(i)).catch(console.error):E()});browser.storage.onChanged.addListener((t,e)=>{if(e==="local"&&t.selectedLocale&&r){const i=r.classList.contains("show");r.remove(),r=null,K().then(()=>{N(),i&&r&&r.classList.add("show")}).catch(console.error)}if(e==="local"&&t.showProgressBar&&r){const i=r.querySelector(".rifm-progress-bar");i&&(i.style.display=t.showProgressBar.newValue!==!1?"block":"none")}});let m=null,f=!1,u=!1,F={},b=null,Q=0,S=[];function _(){if(S.length===0){f=!1,u=!1,m=null,b&&clearInterval(b),E(),q();return}V(S.length);const t=S.shift();I(t.text,t.voiceIndex,t.rate,t.pitch,t.volume)}function I(t,e,i,n,l){const o=ee(t),c=new SpeechSynthesisUtterance(o),x=150*(i||1),h=o.split(/\s+/).length/x*60;Z(h);const k=window.speechSynthesis.getVoices();if(e!==void 0&&k[e])c.voice=k[e];else{const L=ie(t),M=se(L);M?c.voice=M:k.length>0&&(c.voice=k[0])}c.rate=i,c.pitch=n,c.volume=l,Q=Date.now(),b&&clearInterval(b),b=window.setInterval(()=>{if(!f||u)return;const L=(Date.now()-Q)/1e3;D(L,h)},100),c.onend=()=>{b&&clearInterval(b),D(100,100),_()},c.onerror=()=>{b&&clearInterval(b),_()},m=c,window.speechSynthesis.speak(c),f=!0,u=!1,q(),V(S.length),H().catch(console.error)}async function X(){return new Promise((t,e)=>{browser.storage.local.get(["selectedLocale"],async i=>{const n=i.selectedLocale||"en";try{const l=browser.runtime.getURL(`_locales/${n}/messages.json`);F=await(await fetch(l)).json(),t()}catch(l){console.error("[ContentScript] Failed to load locale:",n,l);try{const o=browser.runtime.getURL("_locales/en/messages.json");F=await(await fetch(o)).json(),t()}catch(o){console.error("[ContentScript] Failed to load fallback locale:",o),e(o)}}})})}function O(t){return F[t]?F[t].message:(console.warn(`[ContentScript] Translation missing for key: ${t}`),{readThis:"Read This",pause:"Pause",resume:"Resume",stop:"Stop",clearQueue:"Clear Queue"}[t]||t)}X().then(()=>{W(),A()}).catch(t=>{console.error("[ContentScript] Failed to load locale, creating tooltip with defaults:",t),W()});function ee(t){let e=t;return e=e.replace(/\s+/g," ").trim(),e=e.replace(/\(([^)]+)\)/g,", $1,"),e=e.replace(/\[([^\]]+)\]/g,", $1,"),e=e.replace(/"([^"]+)"/g,", $1,"),e=e.replace(/'([^']+)'/g,"$1"),e=e.replace(/\bDr\./gi,"Doctor"),e=e.replace(/\bMr\./g,"Mister"),e=e.replace(/\bMrs\./g,"Misses"),e=e.replace(/\bMs\./g,"Miss"),e=e.replace(/\bProf\./gi,"Professor"),e=e.replace(/\bSt\./g,"Saint"),e=e.replace(/\bAve\./g,"Avenue"),e=e.replace(/\bBlvd\./g,"Boulevard"),e=e.replace(/\bRd\./g,"Road"),e=e.replace(/\betc\./gi,"etcetera"),e=e.replace(/\be\.g\./gi,"for example"),e=e.replace(/\bi\.e\./gi,"that is"),e=e.replace(/\bvs\./gi,"versus"),e=e.replace(/\betc\b/gi,"etcetera"),e=e.replace(/\baka\b/gi,"also known as"),e=e.replace(/(\d{1,2}):(\d{2})\s*(am|pm)/gi,"$1 $2 $3"),e=e.replace(/(\d{1,2}):(\d{2})/g,"$1 $2"),e=e.replace(/(\d{1,2})\/(\d{1,2})\/(\d{2,4})/g,"$1 $2 $3"),e=e.replace(/(\d+)(st|nd|rd|th)\b/gi,"$1$2"),e=e.replace(/(\d+),(\d{3})/g,"$1$2"),e=e.replace(/\s*--\s*/g,", "),e=e.replace(/\s*—\s*/g,", "),e=e.replace(/\.\s+/g,". "),e=e.replace(/\?\s+/g,"? "),e=e.replace(/!\s+/g,"! "),e=e.replace(/,\s*/g,", "),e=e.replace(/;\s*/g,"; "),e=e.replace(/:\s*/g,": "),e=e.replace(/https?:\/\/[^\s]+/g," "),e=e.replace(/www\.[^\s]+/g," "),e=e.replace(/[\w.-]+@[\w.-]+\.\w+/g," "),e=e.replace(/\.{2,}/g,","),e=e.replace(/!{2,}/g,"!"),e=e.replace(/\?{2,}/g,"?"),e=e.replace(/[*_#`~\[\]]/g,""),e=e.replace(/^\s*[-•]\s*/gm,""),e=e.replace(/\b([A-Z]{2,})\b/g,i=>i.length<=4?i.split("").join(". "):i.toLowerCase()),e=e.replace(/\s+/g," "),e=e.replace(/,\s*,+/g,","),e=e.replace(/\s*,\s*/g,", "),e.trim()}function q(){browser.runtime.sendMessage({action:"stateUpdate",state:{isReading:f,isPaused:u,currentText:(m==null?void 0:m.text)||""}}),window.dispatchEvent(new CustomEvent("rifm-state-update",{detail:{isReading:f,isPaused:u}}))}browser.runtime.onMessage.addListener((t,e,i)=>{var n,l;if(t.action==="getSelectedText"){const o=((n=window.getSelection())==null?void 0:n.toString())||"",c=document.documentElement.lang||((l=document.querySelector('meta[http-equiv="content-language"]'))==null?void 0:l.getAttribute("content"))||navigator.language;return i({text:o,language:c}),!0}if(t.action==="startReading"){const{text:o,voiceIndex:c,rate:x,pitch:v,volume:h}=t;return f&&!u?(S.push({text:o,voiceIndex:c,rate:x,pitch:v,volume:h}),i({success:!0,queued:!0})):(m&&(m.onend=null,m.onerror=null,window.speechSynthesis.cancel()),S=[],I(o,c,x,v,h),i({success:!0,queued:!1})),!0}return t.action==="pauseReading"?(f&&!u&&(window.speechSynthesis.pause(),u=!0,j(!0),q()),i({success:!0}),!0):t.action==="resumeReading"?(f&&u&&(window.speechSynthesis.resume(),u=!1,j(!1),q()),i({success:!0}),!0):t.action==="stopReading"?(window.speechSynthesis.cancel(),S=[],f=!1,u=!1,m=null,b&&clearInterval(b),V(0),q(),i({success:!0}),!0):t.action==="clearQueue"?(S=[],V(0),i({success:!0}),!0):(t.action==="updateSettings"&&(m&&f&&(t.rate!==void 0&&(m.rate=t.rate),t.pitch!==void 0&&(m.pitch=t.pitch),t.volume!==void 0&&(m.volume=t.volume)),i({success:!0})),!0)});document.addEventListener("keydown",t=>{if(t.code==="Space"&&f&&!te()&&(t.preventDefault(),u?browser.runtime.sendMessage({action:"resumeReading"}):browser.runtime.sendMessage({action:"pauseReading"})),t.code==="Escape"&&f&&browser.runtime.sendMessage({action:"stopReading"}),t.ctrlKey&&t.shiftKey&&t.code==="KeyR"){t.preventDefault();const e=window.getSelection();(e==null?void 0:e.toString().trim())&&G()}});function te(){const t=document.activeElement;return t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement||t instanceof HTMLSelectElement||(t==null?void 0:t.isContentEditable)}let p=null;function W(){p||(p=document.createElement("div"),p.id="rifm-selection-tooltip",p.innerHTML=`
    <style>
